...
@section('content')
<div class="rx"></div>
<h3><i class="fa fa-angle-right"></i> Phiếu kiểm kê mới</h3>
<hr>
<div class="row mt">
<!-- strat form -->
                    ...
                    <table class="table table-bordered table-striped table-condensed cf" class="table" id="table-add">
                        ...
                        <tr>
                            ...
                            <td class="numeric" data-title="Số lượng tồn kho">
                                <span><input data-bind="value: sl_ton_kho ,valueUpdate: 'input'" type="number" name="don_gia[]" placeholder=""  min="1000" step="1000" class="w3-input w3-border" pattern="[0-9]*"align="" readonly="true"></span>
