...
<div class="row">
    <div class="col-sm-9">
        <h3><i class="fa fa-angle-right"></i> Danh sách hóa đơn</h3>
    </div>
        ...
        <div class="content-panel">
            <section id="no-more-tables">
                <table id="DBtableJQuery"class="table table-bordered table-striped table-condensed cf">
                    ...
                    @foreach($data as $d)
                      <tr>
                        <td data-title="# Mã đơn đặt hàng"><a href="" title="" data-toggle="modal" data-target="#modal-info-{{$d->id}}">{{$d->ma_hd}}</a>
                         @include('bill.detail')
                         </td>
                                      ...
                                      <h4 class="modal-title">Xác nhận xóa</h4>
                                        ...
                                        <div class="modal-body">
                                            <p class="lead">
                                                ...
                                                Bạn có chắc chắn xóa {{$d->ma_hd}} từ {{$d->ma_kh}}?
                                            </p>
                                        </div>
